...
\noindent
Using the Earth-Moon CR3BP three-body parameter ($\mu = 0.012155$), Table \ref{t:lagrange_points} shows the non-dimensional locations of the five Lagrange points to six significant figures. Additionally, Figure \ref{f:lagrange_points} graphically shows these locations along with a contour plot of the CR3BP's zero-velocity curves for varying Jacobi constants. As Figure \ref{f:lagrange_points} shows, L$_1$, L$_2$, and L$_3$ lie at saddle points, while L$_4$ and L$_5$ lie at extrema values.
...
In this section a planar stability analysis is performed about each Lagrange point in the Earth-Moon CR3BP. This entails linearizing the rotational equations of motion about each equilibrium solution and solving for small departures from the equilibrium. 
