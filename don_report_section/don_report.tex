...
\begin{figure}[H]
    \centering
    \includegraphics[width=6in]{L1_clamshell_comb.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=6in]{manifold_comb.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=6in]{poincare_comb.png}
    \caption{This figure shows...}
    \label{f:poincare}
\end{figure}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=6in]{sym_homo_comb.png}
    \caption{This figure shows...}
    \label{f:sym_homo}
\end{figure}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=6in]{asym_homo_comb.png}
    \caption{This figure shows...}
    \label{f:asy_homo}
\end{figure}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=6in]{interior_exterior.png}
    \caption{This figure \textbf{shows... \cite{KoonLoMarsdenRoss2011}}.}
